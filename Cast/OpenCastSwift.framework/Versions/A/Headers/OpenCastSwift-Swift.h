...
#ifndef OPENCASTSWIFT_SWIFT_H
#define OPENCASTSWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenCastSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13OpenCastSwift15AppAvailability")
@interface AppAvailability : NSObject
...
SWIFT_CLASS("_TtC13OpenCastSwift7CastApp")
...
SWIFT_CLASS("_TtC13OpenCastSwift10CastClient")
...
@interface CastClient (SWIFT_EXTENSION(OpenCastSwift)) <NSStreamDelegate>
...
SWIFT_PROTOCOL("_TtP13OpenCastSwift18CastClientDelegate_")
...
- (void)castClient:(CastClient * _Nonnull)client connectionTo:(CastDevice * _Nonnull)device didFailWith:(NSError * _Nullable)error;
...
SWIFT_CLASS("_TtC13OpenCastSwift10CastDevice")
...
SWIFT_CLASS("_TtC13OpenCastSwift17CastDeviceScanner")
...
@interface CastDeviceScanner (SWIFT_EXTENSION(OpenCastSwift)) <NSNetServiceDelegate>
...
@interface CastDeviceScanner (SWIFT_EXTENSION(OpenCastSwift)) <NSNetServiceBrowserDelegate>
...
SWIFT_CLASS("_TtC13OpenCastSwift9CastMedia")
...
SWIFT_CLASS("_TtC13OpenCastSwift15CastMediaStatus")
...
SWIFT_CLASS("_TtC13OpenCastSwift11CastRequest")
@interface CastRequest : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC13OpenCastSwift10CastStatus")
